...
<table class="table">
 ...
 <?php 
    ...
    <!-- <button class="btn btn-primary"><a href="updated.php? updateid='.$id.'" class="text-light">Update</a></button>-->
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <a href="deleted.php? deleteid='.$id.'" class="btn btn-danger" >Delete it</a>
